...
class _UnitDetailScreenState extends State<UnitDetailScreen> {
  ...
  Widget _contactBar() {
    final palette = context.palette;
    final whatsappNumber = widget.project.agency.whatsapp ?? widget.project.agency.phone;
    final callNumber = widget.project.agency.phone;
    return ClipRRect(
                      ...
                      Expanded(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () {
                            ...
                            launchUrl(Uri.parse('https://wa.me/964${whatsappNumber.replaceFirst(RegExp(r'^0'), '')}'), mode: LaunchMode.externalApplication);
                          },
                    ...
                    if (callNumber != null)
                      Expanded(
                        ...
                        child: OutlinedButton.icon(
                          onPressed: () {
                            context.read<ActivityRepository>().recordContact(type: 'project', id: widget.project.id);
                            launchUrl(Uri.parse('tel:+964${callNumber.replaceFirst(RegExp(r'^0'), '')}'));
                          },
